		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Reuse Consumer UI",
									"targetURL": "#comndbsreuseconsumerui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comndbsreuseconsumerui-display": {
								"semanticObject": "comndbsreuseconsumerui",
								"action": "display",
								"description": "Reuse Consumer UI",
								"title": "Reuse Consumer UI",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ndbs.reuseconsumerui",
									"url": sap.ui.require.toUrl("com/ndbs/reuseconsumerui")
								}
							}
						}
					}
